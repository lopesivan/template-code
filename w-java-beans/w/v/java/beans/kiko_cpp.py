...
__CHEETAH_genTime__ = 1621218548.9235215
__CHEETAH_genTimestamp__ = 'Sun May 16 23:29:08 2021'
__CHEETAH_src__ = '../m/kiko_cpp.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 16 23:11:40 2021'
...
class kiko_cpp(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(kiko_cpp, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_kiko_cpp = 'respond'

## END CLASS DEFINITION

if not hasattr(kiko_cpp, '_initCheetahAttributes'):
    templateAPIClass = getattr(kiko_cpp,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(kiko_cpp)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=kiko_cpp()).run()
