...
__CHEETAH_genTime__ = 1621218549.0545375
__CHEETAH_genTimestamp__ = 'Sun May 16 23:29:09 2021'
__CHEETAH_src__ = '../m/kuku.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 16 23:16:26 2021'
...
class kuku(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(kuku, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_kuku = 'respond'

## END CLASS DEFINITION

if not hasattr(kuku, '_initCheetahAttributes'):
    templateAPIClass = getattr(kuku,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(kuku)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=kuku()).run()
