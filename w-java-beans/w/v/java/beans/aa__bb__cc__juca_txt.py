...
__CHEETAH_genTime__ = 1621218549.3100228
__CHEETAH_genTimestamp__ = 'Sun May 16 23:29:09 2021'
__CHEETAH_src__ = '../m/aa__bb__cc__juca_txt.tmpl'
__CHEETAH_srcLastModified__ = 'Sun May 16 23:29:06 2021'
...
class aa__bb__cc__juca_txt(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(aa__bb__cc__juca_txt, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_aa__bb__cc__juca_txt = 'respond'

## END CLASS DEFINITION

if not hasattr(aa__bb__cc__juca_txt, '_initCheetahAttributes'):
    templateAPIClass = getattr(aa__bb__cc__juca_txt,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(aa__bb__cc__juca_txt)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=aa__bb__cc__juca_txt()).run()
