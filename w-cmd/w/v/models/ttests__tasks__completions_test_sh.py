...
class TTests__tasks__completions_test_sh(Factory):
    """Classe de template."""
    def __init__(self, data_model, template_name):
        ...
        self.tmpl.name = "%s/%s" %(self.tmpl.cmd['dir'], "tests/tasks/completions.test_sh".replace('template', self.tmpl.cmd['name']))
