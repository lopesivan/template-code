...
class TLinux__conan__recipe__conanfiledot_py(Factory):
    """Classe de template."""
    def __init__(self, data_model, template_name):
        ...
        self.tmpl.name = "%s/%s" %(self.tmpl.data['dir'], "linux/conan/recipe/conanfile.py".replace("linux", self.tmpl.data['name']))
