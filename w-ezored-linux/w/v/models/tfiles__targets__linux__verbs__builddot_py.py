...
class TFiles__targets__linux__verbs__builddot_py(Factory):
    """Classe de template."""
    def __init__(self, data_model, template_name):
        ...
        self.tmpl.name = "%s/%s" %(self.tmpl.data['dir'], "files/targets/linux/verbs/build.py".replace("linux", self.tmpl.data['name']))
