...
__CHEETAH_genTime__ = 1658985215.4552789
__CHEETAH_genTimestamp__ = 'Thu Jul 28 02:13:35 2022'
__CHEETAH_src__ = '../m/linux__verbs__distdot_py.tmpl'
...
class linux__verbs__distdot_py(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(linux__verbs__distdot_py, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_linux__verbs__distdot_py = 'respond'

## END CLASS DEFINITION

if not hasattr(linux__verbs__distdot_py, '_initCheetahAttributes'):
    templateAPIClass = getattr(linux__verbs__distdot_py,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(linux__verbs__distdot_py)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=linux__verbs__distdot_py()).run()
