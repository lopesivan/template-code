...
set(PROJECT_CONFIG_NAME
    ""''')
        _v = VFFSL(SL,"data.project.name",True) # '${data.project.name}' on line 6, col 7
        if _v is not None: write(_filter(_v, rawExpr='${data.project.name}')) # from line 6, col 7.
        write('''""
