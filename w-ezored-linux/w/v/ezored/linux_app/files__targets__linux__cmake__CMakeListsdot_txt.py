...
__CHEETAH_genTime__ = 1659066902.0089664
__CHEETAH_genTimestamp__ = 'Fri Jul 29 00:55:02 2022'
__CHEETAH_src__ = '../m/files__targets__linux__cmake__CMakeListsdot_txt.tmpl'
__CHEETAH_srcLastModified__ = 'Thu Jul 28 18:36:51 2022'
...
set(PROJECT_CONFIG_NAME
    "''')
        _v = VFFSL(SL,"data.project.name",True) # '${data.project.name}' on line 6, col 6
        if _v is not None: write(_filter(_v, rawExpr='${data.project.name}')) # from line 6, col 6.
        write('''"
...
set(PROJECT_CONFIG_VERSION
    "''')
        _v = VFFSL(SL,"data.project.version",True) # '${data.project.version}' on line 21, col 6
        if _v is not None: write(_filter(_v, rawExpr='${data.project.version}')) # from line 21, col 6.
        write('''"
...
set(PROJECT_CONFIG_ARCH
    "''')
        _v = VFFSL(SL,"data.project.arch",True) # '${data.project.arch}' on line 26, col 6
        if _v is not None: write(_filter(_v, rawExpr='${data.project.arch}')) # from line 26, col 6.
        write('''"
