...
__CHEETAH_genTime__ = 1658985215.7287195
__CHEETAH_genTimestamp__ = 'Thu Jul 28 02:13:35 2022'
__CHEETAH_src__ = '../m/linux__conan__recipe__conanfiledot_py.tmpl'
...
class linux__conan__recipe__conanfiledot_py(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(linux__conan__recipe__conanfiledot_py, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_linux__conan__recipe__conanfiledot_py = 'respond'

## END CLASS DEFINITION

if not hasattr(linux__conan__recipe__conanfiledot_py, '_initCheetahAttributes'):
    templateAPIClass = getattr(linux__conan__recipe__conanfiledot_py,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(linux__conan__recipe__conanfiledot_py)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=linux__conan__recipe__conanfiledot_py()).run()
