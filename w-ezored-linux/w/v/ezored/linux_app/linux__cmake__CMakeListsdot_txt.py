...
__CHEETAH_genTime__ = 1658985215.9962578
__CHEETAH_genTimestamp__ = 'Thu Jul 28 02:13:35 2022'
__CHEETAH_src__ = '../m/linux__cmake__CMakeListsdot_txt.tmpl'
...
class linux__cmake__CMakeListsdot_txt(Template):
    ...
    def __init__(self, *args, **KWs):
        ...
        super(linux__cmake__CMakeListsdot_txt, self).__init__(*args, **KWs)
...
''')
    ...
    _mainCheetahMethod_for_linux__cmake__CMakeListsdot_txt = 'respond'

## END CLASS DEFINITION

if not hasattr(linux__cmake__CMakeListsdot_txt, '_initCheetahAttributes'):
    templateAPIClass = getattr(linux__cmake__CMakeListsdot_txt,
                               '_CHEETAH_templateClass',
                               Template)
    templateAPIClass._addCheetahPlumbingCodeToClass(linux__cmake__CMakeListsdot_txt)
...
if __name__ == '__main__':
    ...
    CmdLineIface(templateObj=linux__cmake__CMakeListsdot_txt()).run()
